...
namespace FlowCanvas{
	...
	public class BinderConnection : Connection {
		...
		public static BinderConnection Create(Port source, Port target){
			...
			if (binder != null){
				binder.SetSource(source, true);
				binder.SetTarget(target, true);
		...
		public void SetSource(Port newSourcePort){ SetSource(newSourcePort, false); }
		void SetSource(Port newSourcePort, bool isNew){
			...
			base.SetSource(newSourcePort.parent);
			if (!isNew){
		...
		public void SetTarget(Port newTargetPort){ SetTarget(newTargetPort, false); }
		void SetTarget(Port newTargetPort, bool isNew){
			...
			base.SetTarget(newTargetPort.parent);
			if (!isNew){
