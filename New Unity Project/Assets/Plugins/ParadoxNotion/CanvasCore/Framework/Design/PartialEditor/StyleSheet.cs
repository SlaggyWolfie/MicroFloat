...
namespace NodeCanvas.Editor {
	...
	public partial class StyleSheet : ScriptableObject {
		...
		[ContextMenu("Lock")] void Lock(){ hideFlags = HideFlags.NotEditable | HideFlags.DontSaveInBuild; }
		[ContextMenu("UnLock")] void UnLock(){ hideFlags = HideFlags.DontSaveInBuild; }
		...
		readonly static System.Collections.Generic.Dictionary<Status, Color> statusColors = new System.Collections.Generic.Dictionary<Status, Color>()
		{
